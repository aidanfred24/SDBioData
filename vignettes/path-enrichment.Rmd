...
In this vignette, we will explore how to perform pathway enrichment analysis using the `SDBioData` package in conjunction with the popular `clusterProfiler` package. We will utilize a sample dataset, `hypoxia_deseq`, which contains differential expression results comparing treatment under hypoxic conditions.
